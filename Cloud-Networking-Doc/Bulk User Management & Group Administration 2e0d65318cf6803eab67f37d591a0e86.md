...
> 
> 
> ![Bulk user 1.PNG](Bulk_user_1.png)
> 

Create user data

![Bulk user 2.PNG](Bulk_user_2.png)

Upload the saved csv file

![Bulk user 3.PNG](Bulk_user_3.png)

View the operation process to see the newly created users

![Bulk user 4.PNG](Bulk_user_4.png)
...
[IAM Security Implementation](IAM%20Security%20Implementation%202e0d65318cf6800cb803c305559fab70.md)